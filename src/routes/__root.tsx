...
import { TreinoProvider } from "@/lib/treino-store";
  ...
  head: () => ({
    meta: [
      ...
      { title: "TREINÔ — Treine certo. Evolua no seu ritmo." },
      {
        name: "description",
        content:
          "TREINÔ é o app de treino que te guia na academia: treino do dia, registro de séries, timer e evolução.",
      },
      { name: "author", content: "TREINÔ" },
